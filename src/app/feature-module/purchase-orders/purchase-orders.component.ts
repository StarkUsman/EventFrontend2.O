...
import { apiResultFormat, pageSelection, purchase } from 'src/app/core/models/models';
...
export class PurchaseOrdersComponent  {
  ...
  constructor(
    ...
    this.pagination.tablePageSize.subscribe((res: tablePageSize) => {
      if (this.router.url == this.routes.purchaseorders) {
  ...
  private getTableData(pageOption: pageSelection): void {
    ...
    this.data.getpurchaseReturn().subscribe((apiRes: apiResultFormat) => {
      this.purchase = [];
